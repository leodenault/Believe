...
public class MainMenuState extends GameStateBase {
	...
	public void init(final GameContainer container, StateBasedGame game)
		...
		playPlatformingLevel.addListener(new LocalLoadGameAction(game, PlatformingState.class));
		playArcadeLevel.addListener(new LocalLoadGameAction(game, ArcadeState.class));
