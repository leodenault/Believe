...
final class CommandSequenceParserImplTest {
  ...
  private final CommandSequenceParserImpl supplier =
  ...
  void parseSequence_returnsCommandContainingSubcommands() {
    Optional<Command> command = supplier.parseSequence(COMMAND_SEQUENCE_SPEC);
  ...
  void parseSequence_sequenceFormatIsInvalid_logsWarningAndReturnsEmpty(
    ...
    assertThat(supplier.parseSequence(INVALID_SEQUENCE_SPEC)).isEmpty();
  ...
  void parseSequence_subcommandDoesNotExist_skipsSubcommand() {
    Optional<Command> command = supplier.parseSequence(COMMAND_SEQUENCE_SPEC_WITH_INVALID_COMMAND);
  ...
  void parseSequence_subcommandRequiresParams_providesParamsToSubcommand() {
    Optional<Command> command =
        supplier.parseSequence(COMMAND_SEQUENCE_SPEC_WITH_COMMAND_CONTAINING_PARAMS);
